...
download_imagebuilder() {
    ...
    download_file="https://downloads.openwrt.org/releases/${rebuild_branch}/targets/armsr/armv8/openwrt-imagebuilder-${rebuild_branch}-armvirt-64.Linux-x86_64.tar.xz"
